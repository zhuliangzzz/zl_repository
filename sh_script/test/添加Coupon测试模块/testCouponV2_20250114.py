...
import flj_testcoupon_20250114 as fljCoupon
from flj_testcoupon_20250114 import check_car_type, check_battery_type
    ...
    def chkCouponMode(self):
        ...
        if check_result != '':
            ...
            if self.ui.checkBox_4.isChecked():
                addQieHoleCoupon.run_qie_hole_step()
    ...
    def addkCouponMode(self):
        ...
        for i, Dict in enumerate(self.allCouponInfo):
            ...
            if hole_name == 'drl':
                ...
                GEN.COM(
                    'sel_copy_other,dest=affected_layers,target_layer=,invert=no,dx=0,dy=0,size=%s,x_anchor=0,y_anchor=0' % enlarge)
                GEN.CLEAR_LAYER()
            # 写入字典，以备后用
