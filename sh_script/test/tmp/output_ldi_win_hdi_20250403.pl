...
sub Check_Output_layer{
	...
	print Dumper(\@send_str);
	
	my $res = system("python /incam/server/site_data/scripts/ynh/toolName_compare/compare_tool_names_new.py sel_check $JOB @send_str");
	return $res;
}
