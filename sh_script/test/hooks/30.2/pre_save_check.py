...
class MainGen():
    ...
    def __init__(self):
        ...
        for dic_info in director_user_info:
            ...
            # 增加伍青的保存权限
            if str(dic_info["user_id"]) == IncamUser and IncamUser not in ('50616', '51059'):
    ...
    def getChangeDetial(self):
        ...
        for info in getData:
            ...
            if Modif is True and 'step=' in repInfo and 'ent_attributes' not in repInfo and 'ncset' not in repInfo:
                modifDetail += repInfo
