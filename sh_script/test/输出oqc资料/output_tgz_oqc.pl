...
system("python /incam/server/site_data/scripts/sh_script/zl/output/Export_Job_oqc.py $job_name $do_tgz_path");
# 20241113 zl 打包tgz
system("python /incam/server/site_data/scripts/sh_script/zl/output/export_idb.py $job_name $username");
