        ...
        if len(light_pad_lays) == 2:
            ...
            if self.step.Selected_count():
                ...
                if self.step.Selected_count():
                    ...
                    for feat in feats:
                        ...
                        add_success = False
                        print(x, y, feat.symbol)
                        # for x_ in range(10 * (x - pad_radius - 3.3), 10 * (x - pad_radius - 1.84), 1):
                        for x_ in range(10 * (x - pad_radius - 1), 10 * (x - pad_radius - 3.3), -1):
                            self.step.addText(x_/10, y - 0.7, 'M', 1.2, 1.4, 0.65616798)
                            self.step.PAUSE(str(x_))
                            self.step.refSelectFilter(make_layer)
                    ...
                    if self.step.Selected_count():
                        ...
                        for feat in feats:
                            ...
                            for x_ in range(10 * (x - pad_radius - 1.84), 10 * (x - pad_radius - 3.3), -1):
                                self.step.addText(x_/10, y - 0.7, 'MC', 1.2, 1.4, 0.65616798)
                                self.step.refSelectFilter(make_layer)
                                if not self.step.Selected_count():
                                    add_success = True
                                    break
                ...
                if self.step.Selected_count():
                    ...
                    for feat in feats:
                        ...
                        # for x_ in range(10 * (x - pad_radius - 3.3), 10 * (x - pad_radius - 1.84), 1):
                        for x_ in range(10 * (x - pad_radius - 1.84), 10 * (x - pad_radius - 3.3), -1):
                            self.step.addText(x_/10, y - 0.7, 'MS', 1.2, 1.4, 0.65616798)
                            self.step.refSelectFilter(make_layer)
                            if not self.step.Selected_count():
                                add_success = True
                                break
            ...
            if self.step.Selected_count():
                ...
                for feat in feats:
                    ...
                    # for x_ in range(10 * (x - pad_radius - 3.3), 10 * (x - pad_radius - 1.84), 1):
                    for x_ in range(10 * (x - pad_radius - 1.84), 10 * (x - pad_radius - 3.3), -1):
                        self.step.addText(x_/10, y - 0.7, text, 1.2, 1.4, 0.65616798)
                        self.step.refSelectFilter(make_layer)
                        if not self.step.Selected_count():
                            add_success = True
                            break
