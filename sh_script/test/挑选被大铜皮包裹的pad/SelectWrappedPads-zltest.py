...
def select_bga_smd_by_surface_around():
    ...
    for worklayer in outsignalLayers:
        ...
        step.COM(
            'set_filter_attributes,filter_name=popup,exclude_attributes=yes,condition=no,attribute=.tear_drop,min_int_val=0,max_int_val=0,min_float_val=0,max_float_val=0,option=,text=')
        step.COM(
            'set_filter_attributes,filter_name=popup,exclude_attributes=yes,condition=no,attribute=.bga,min_int_val=0,max_int_val=0,min_float_val=0,max_float_val=0,option=,text=')
        step.COM(
            'set_filter_attributes,filter_name=popup,exclude_attributes=yes,condition=no,attribute=.area,min_int_val=0,max_int_val=0,min_float_val=0,max_float_val=0,option=,text=')
        ...
        if step.Selected_count():
            step.selectDelete()
        step.COM("sel_resize,size=-{0}".format(20 * 25.4))  # 20241104 变形
        step.selectAll()
