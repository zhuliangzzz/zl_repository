...
class Pnl_fill_copper:
    ...
    def create_honeycomb_tmp(self):
        ...
        self.GEN.DELETE_LAYER(profile_layer)
        flat_profile = profile_layer + '+++'
        self.GEN.CREATE_LAYER(flat_profile)
        ...
        self.GEN.OPEN_STEP(self.STEP)
        self.GEN.CLEAR_LAYER()
        self.GEN.COM('flatten_layer,source_layer=%s,target_layer=%s' % (profile_layer, flat_profile))
        self.GEN.COM("affected_layer,name=honeycomb-t,mode=single,affected=yes")
        self.GEN.COM("affected_layer,name=honeycomb-b,mode=single,affected=yes")
        self.GEN.COM('clip_area_end,layers_mode=affected_layers,layer=,area=reference,area_type=rectangle,inout=inside,contour_cut=no,margin=0.25,ref_layer=%s,feat_types=line\;pad\;surface\;arc\;text' % flat_profile)
        self.GEN.COM('affected_layer,mode=all,affected=no')
        self.GEN.DELETE_LAYER(profile_layer)
