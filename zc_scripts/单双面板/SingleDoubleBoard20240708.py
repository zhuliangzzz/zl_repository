...
class Panel():
    ...
    def make_map_layer(self):
        ...
        x3, y3 = step.profile2.xmax - 3.5, step.profile2.ymax - 52
    ...
    def do_sy(self):
        if board.map_flag:
            ...
            for signal in self.signalLays:
                ...
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 52, sym, 'negative', 90)
            ...
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 52, 'r2500')
            ...
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 52, 'r2000')
    ...
    def do_film(self):
        if board.map_flag:
            ...
            for signal in self.signalLays:
                ...
                if step.isLayer(dk):
                    step.affect(dk)
                    step.addPad(step.profile2.xmin + 5, step.sr2.ymax - 57, sym, 'negative')
                    step.addPad(step.profile2.xmin + 5, step.sr2.ymin + 57, sym, 'negative')
                    step.addPad(step.profile2.xmax - 5, step.sr2.ymax - 57, sym, 'negative', angle=180)
                    step.addPad(step.profile2.xmax - 5, step.sr2.ymin + 72, sym, 'negative', angle=180)
                    step.unaffectAll()
            step.affect('map')
            step.addPad(step.profile2.xmin + 5, step.sr2.ymax - 57, 'base_film_map')
            step.addPad(step.profile2.xmin + 5, step.sr2.ymin + 57, 'base_film_map')
    ...
    def do_lpi(self):
        ...
        for dk in self.dks:
            step.affect(dk)
        step.addPad(29.5, 9, 'r3000', 'negative')
        ...
        step.addPad(step.profile2.xmax - 31, 9, 'r3000', 'negative')
        step.unaffectAll()
        step.VON()
