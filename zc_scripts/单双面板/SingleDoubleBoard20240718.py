...
class Panel():
    ...
    def make_map_layer(self):
        ...
        step.addPad(step.profile2.xmax - 3.5, 56, 'qp', angle=270)
    ...
    def do_surface(self):
        ...
        for lay in self.signalLays:
            if i % 2:
                ...
                y_off = 0
            step.affect(lay)
            step.srFill_2(step_margin_x=1, step_margin_y=1, nest_sr='no')
    ...
    def do_sy(self):
        if board.map_flag:
            ...
            for dk in self.dks:
                step.affect(dk)
            step.addPad(3.5, step.profile2.ymax - 21, 'r3400')
            step.addPad(3.5, step.profile2.ymin + 18, 'r3400')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 54, 'r3400')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 18, 'r3400')
            step.unaffectAll()
            for drill in self.drills:
                step.affect(drill)
    ...
    def do_component(self):
        if board.map_flag:
            ...
            for dk in self.dks:
                ...
                # r-mark
                signal = 'gtl' if dk == 'dkt' else 'gbl'
                sym = 'r-mark-t' if board.signal_dict.get(signal) == 't' else 'r-mark-b'
                step.addPad(3.5, step.profile2.ymax - 32, sym, 'negative', 270)
                step.addPad(3.5, step.profile2.ymin + 34, sym, 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 29, sym, 'negative', 90)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 32, sym, 'negative', 90)
                ...
                # c-mark-t
                signal = 'gtl' if dk == 'dkt' else 'gbl'
                sym = 'c-mark-t' if board.signal_dict.get(signal) == 't' else 'c-mark-b'
                step.addPad(3.5, step.profile2.ymax - 55, sym, 'negative', 270)
                step.addPad(3.5, step.profile2.ymin + 47, sym, 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 42, sym, 'negative', 90)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 28, sym, 'negative', 90)
                ...
                # wf-mark-t
                sym = 'wf-mark-t' if board.signal_dict.get(signal) == 't' else 'wf-mark-b'
                step.addPad(3.5, step.profile2.ymax - 49, sym, 'negative', 270)
                step.addPad(3.5, step.profile2.ymin + 26.5, sym, 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 49, sym, 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 48, sym, 'negative', 270)
                ...
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 49, 'r2600', 'negative', 270)
    ...
    def do_qp(self):
        if board.map_flag:
            ...
            step.addPad(step.profile2.xmax - 3.5, 56, 'qp-xl', angle=270)
            step.unaffectAll()
            step.affect('map')
            # 左右
            step.addPad(3.5, step.profile2.ymax - 75.5, 'qp', angle=90)
            ...
            step.addPad(step.profile2.xmax - 3.5, 56, 'qp-f', angle=270)
            step.unaffectAll()
    ...
    def do_donut(self):
        ...
        for dk in self.dks:
            step.affect(dk)
        step.addPad(xb1, step.sr2.ymin - 3.5, 'r2200', 'negative', nx=3, dx=3000)
        step.addPad(xb3, step.sr2.ymin - 3.5, 'r2200', 'negative', nx=3, dx=3000)
        step.addPad(xt1, step.sr2.ymax + 3.5, 'r2200', 'negative', nx=3, dx=3000)
        step.addPad(xt3, step.sr2.ymax + 3.5, 'r2200', 'negative', nx=3, dx=3000)
        # 左右线宽线距pad
    ...
    def do_2d(self):
        if board.map_flag:
            ...
            for dk in self.dks:
                step.affect(dk)
            step.addPad(97.5 + 2.5, step.sr2.ymax + 2 + 2.5, 's6000', 'negative')
            step.addPad(step.profile2.xmax - 102.5 + 2.5, step.sr2.ymax + 2 + 2.5, 's6000', 'negative')
            step.unaffectAll()
            step.VON()
