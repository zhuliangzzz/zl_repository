...
class Panel():
    ...
    def make_map_layer(self):
        ...
        # qp
        # 左右
        step.addPad(7.6, step.profile2.ymax - 75.5, 'qp-map', angle=90)
    ...
    def do_2d(self):
        ...
        for dk in self.dks:
            step.affect(dk)
        step.addPad(100, step.sr2.ymax + 4.5, 's6000', 'negative')
        step.addPad(step.profile2.xmax - 100, step.sr2.ymax + 4.5, 's6000', 'negative')
        step.unaffectAll()
        step.VON()
