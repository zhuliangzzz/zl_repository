...
class Panel():
    ...
    def make_map_layer(self):
        ...
        x2, y2 = 3.5, step.profile2.ymin + 18.5
        x3, y3 = step.profile2.xmax - 3.5, step.profile2.ymax - 53
        x4, y4 = step.profile2.xmax - 3.5, step.profile2.ymin + 18.5
        step.addPad(x1, y1, sym, 'positive', 270)
        step.addPad(x2, y2, sym, 'positive', 270)
        step.addPad(x3, y3, sym, 'positive', 90)
        step.addPad(x4, y4, sym, 'positive', 90)
        ...
        step.addPad(3.5, step.profile2.ymin + 44, 'jsk')
        ...
        step.addPad(3.5, step.profile2.ymin + 41.5, 's1500')
        ...
        step.addPad(3.5, step.profile2.ymin + 38, 'wzdw')
        ...
        step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 42, sym, 'positive', 90)
        step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 28, sym, 'positive', 90)
        # 中间
        ...
        step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 49, sym, 'positive', 270)
        ...
        step.addPad(3.5, step.profile2.ymin + 23, 'sy-mark', 'positive', 270)
        step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 23, 'sy-mark', 'positive', 270)
        step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 23, 'sy-mark', 'positive', 270)
        # 中间
        ...
        # film
        step.addPad(step.profile2.xmin + 5, step.profile2.ymax - 88, 'base_film_map')
        step.addPad(step.profile2.xmin + 5, step.profile2.ymin + 73, 'base_film_map')
        step.addPad(step.profile2.xmax - 5, step.profile2.ymax - 72, 'base_film_map', angle=180)
        ...
        # qp
        # 左右
        step.addPad(7.6, step.profile2.ymax - 75.5, 'qp', angle=90)
        step.addPad(7.6, step.profile2.ymin + 39, 'qp', angle=90)
        step.addPad(step.profile2.xmax - 7.6, step.profile2.ymax - 36.5, 'qp', angle=270)
        step.addPad(step.profile2.xmax - 7.6, 50, 'qp', angle=270)
    ...
    def do_surface(self):
        ...
        if self.dks:
            for n, dk in enumerate(self.dks):
                ...
                # 网格铜边到边间距
                side_spacing = 600
                dk_tmp = f'{dk}+++{step.pid}'
                if dk == 'dkt':
                    step.Flatten(self.signalLays[0], dk_tmp)
                else:
                    step.Flatten(self.signalLays[-1], dk_tmp)
                step.affect(dk)
                step.srFill_2(sr_margin_x=2, sr_margin_y=2, stop_at_steps='pcs')
                tmp = dk + '+++'
                step.copySel(tmp)
                step.unaffectAll()
                step.affect(tmp)
    ...
    def do_sy(self):
        if board.map_flag:
            ...
            for signal in self.signalLays:
                ...
                step.addPad(3.5, step.profile2.ymax - 21, sym, 'negative', 270)
                step.addPad(3.5, step.profile2.ymin + 18.5, sym, 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 53, sym, 'negative', 90)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 18.5, sym, 'negative', 90)
                step.unaffectAll()
            step.affect('map')
            step.addPad(3.5, step.profile2.ymax - 21, sym, 'negative', 270)
            step.addPad(3.5, step.profile2.ymin + 18.5, sym, 'negative', 270)
            ...
            step.addPad(3.5, step.profile2.ymin + 18.5, 'r2500')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 53, 'r2500')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 18.5, 'r2500')
            step.unaffectAll()
            for drill in self.drills:
                step.affect(drill)
            step.addPad(3.5, step.profile2.ymax - 21, 'r2000')
            step.addPad(3.5, step.profile2.ymin + 18.5, 'r2000')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 53, 'r2000')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 18.5, 'r2000')
            step.unaffectAll()
            step.VON()
    ...
    def do_component(self):
        if board.map_flag:
            ...
            for signal in self.signalLays + ['map']:
                ...
                step.addPad(3.5, step.profile2.ymax - 44, 'jsk')
                step.addPad(3.5, step.profile2.ymin + 44, 'jsk')
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 38, 'jsk')
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 44, 'jsk')
                # 中间
                step.addPad(3.5, step.profile2.ycenter - 7, 'jsk')
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ycenter - 2, 'jsk')
                ...
                step.addPad(3.5, step.profile2.ymin + 41.5, 's1500', 'negative')
                ...
                step.addPad(3.5, step.profile2.ymin + 38, 'wzdw', 'negative')
                ...
                step.addPad(3.5, step.profile2.ymin + 47, sym, 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 42, sym, 'negative', 90)
                step.addPad(step.profile2.xmax - 3.5, step.profile.ymin + 28, sym, 'negative', 90)
                # 中间
                ...
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 49, sym, 'negative', 270)
                ...
                step.addPad(3.5, step.profile2.ymin + 23, 'sy-mark', 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 23, 'sy-mark', 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 23, 'sy-mark', 'negative', 270)
                # 中间
            ...
            step.addPad(3.5, step.profile2.ymin + 44, 'r500')
            ...
            step.addPad(3.5, step.profile2.ymin + 41.5, 'r2501', 'negative')
            ...
            step.addPad(3.5, step.profile2.ymin + 38, 'r2501', 'negative')
            ...
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 42, 'r2501', 'negative', 90)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 28, 'r2501', 'negative', 90)
            # wf-mark-t
            step.addPad(3.5, step.profile2.ymax - 49, 'r2501', 'negative', 270)
            step.addPad(3.5, step.profile2.ymin + 26.5, 'r2501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 49, 'r2501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 48, 'r2501', 'negative', 270)
            # sy-mark
            step.addPad(3.5, step.profile2.ymax - 28, 'r3501', 'negative', 270)
            step.addPad(3.5, step.profile2.ymin + 23, 'r3501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 23, 'r3501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 23, 'r3501', 'negative', 270)
            step.unaffectAll()
            for yy in self.yys:
                step.affect(yy)
            # sym = 'r1860'
            ...
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 42, 'r2100', 'positive', 90)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 28, 'r2100', 'positive', 90)
            # 中间
            ...
            if board.radioButton_other.isChecked():
                ...
                step.addPad(3.5, step.profile2.ymin + 23, 'r3000', 'positive', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 23, 'r3000', 'positive', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 23, 'r3000', 'positive', 270)
                # 中间
                ...
                step.addPad(3.5, step.profile2.ymin + 38, 'r2800')
                ...
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 49, 'r2500', 'positive', 270)
            ...
            step.addPad(3.5, step.profile2.ymin + 23, 'sy-1', 'positive', 270)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 23, 'sy-1', 'positive', 270)
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymin + 23, 'sy-1', 'positive', 270)
            # 中间
    ...
    def do_lpi(self):
        ...
        for dk in self.dks:
            step.affect(dk)
        step.addPad(33, 9, 'r3000', 'negative')
        step.addPad(36, step.profile2.ymax - 9, 'r3000', 'negative')
        step.addPad(step.profile2.xmax - 35.5, step.profile2.ymax - 9, 'r3000', 'negative')
        step.addPad(step.profile2.xmax - 33, 9, 'r3000', 'negative')
        step.unaffectAll()
        step.VON()
    ...
    def do_qp(self):
        if board.map_flag:
            ...
            for dk in self.dks:
                step.affect(dk)
            # 左右
            step.addPad(7.6, step.profile2.ymax - 75.5, 'qp-xl', angle=90)
            ...
            for drill in self.drills:
                step.affect(drill)
            # 左右
            step.addPad(7.6, step.profile2.ymax - 75.5, 'qp-f', angle=90)
    ...
    def do_donut(self):
        ...
        # 下上
        step.addPad(xb1, step.sr2.ymin - 3.5, 'r2200')
        step.addPad(xb1 + 3, step.sr2.ymin - 3.5, 'r2200')
        step.addPad(xb1 + 6, step.sr2.ymin - 3.5, 'r2200')
        step.addPad(xb3, step.sr2.ymin - 3.5, 'r2200')
        step.addPad(xb3 + 3, step.sr2.ymin - 3.5, 'r2200')
        step.addPad(xb3 + 6, step.sr2.ymin - 3.5, 'r2200')
        step.addPad(xt1, step.sr2.ymax + 3.5, 'r2200')
        step.addPad(xt1 + 3, step.sr2.ymax + 3.5, 'r2200')
        step.addPad(xt1 + 6, step.sr2.ymax + 3.5, 'r2200')
        step.addPad(xt3, step.sr2.ymax + 3.5, 'r2200')
        step.addPad(xt3 + 3, step.sr2.ymax + 3.5, 'r2200')
        step.addPad(xt3 + 6, step.sr2.ymax + 3.5, 'r2200')
        ...
        for zh in self.zhs:
            step.affect(zh)
        step.addPad(xb1, step.sr2.ymin - 3.5, 'r1000', 'negative', nx=3, dx=3000)
        step.addPad(xb3, step.sr2.ymin - 3.5, 'r1000', 'negative', nx=3, dx=3000)
        step.addPad(xt1, step.sr2.ymax + 3.5, 'r1000', 'negative', nx=3, dx=3000)
        step.addPad(xt3, step.sr2.ymax + 3.5, 'r1000', 'negative', nx=3, dx=3000)
        ...
        # step.addPad(xb1 - 10.5, step.sr2.ymin - 3.5, 'r3000')  # 线宽线距symbol
        # step.addPad(xb1 - 6.4, step.sr2.ymin - 3.5, 'r3000')  # 线宽线距symbol
        # step.addPad(xb3 - 10.5, step.sr2.ymin - 3.5, 'r3000')  # 线宽线距symbol
        # step.addPad(xb3 - 6.4, step.sr2.ymin - 3.5, 'r3000')  # 线宽线距symbol
        ...
        for yy in self.yys:
            step.affect(yy)
        step.addPad(xb1, step.sr2.ymin - 3.5, 'r3500', nx=3, dx=3000)
        step.addPad(xb3, step.sr2.ymin - 3.5, 'r3500', nx=3, dx=3000)
        step.addPad(xt1, step.sr2.ymax + 3.5, 'r3500', nx=3, dx=3000)
        step.addPad(xt3, step.sr2.ymax + 3.5, 'r3500', nx=3, dx=3000)
        ...
        # step.addPad(xb1 - 10.5, step.sr2.ymin - 3.5, 'r4500')  # 线宽线距symbol
        # step.addPad(xb1 - 6.4, step.sr2.ymin - 3.5, 'r4500')  # 线宽线距symbol
        # step.addPad(xb3 - 10.5, step.sr2.ymin - 3.5, 'r4500')  # 线宽线距symbol
        # step.addPad(xb3 - 6.4, step.sr2.ymin - 3.5, 'r4500')  # 线宽线距symbol
    ...
    def do_2d(self):
        for signal in self.signalLays:
            step.affect(signal)
        step.addPad(97.5, step.sr2.ymax + 2, '2d', 'negative')
        step.addPad(step.profile2.xmax - 102.5, step.sr2.ymax + 2, '2d', 'negative')
        step.unaffectAll()
        step.affect('2d')
        step.addPad(97.5, step.sr2.ymax + 2, '2d')
        step.addPad(step.profile2.xmax - 102.5, step.sr2.ymax + 2, '2d')
        step.unaffectAll()
        step.VOF()
        for dk in self.dks:
            step.affect(dk)
        step.addPad(97.5, step.sr2.ymax + 2, 's6000', 'negative')
        step.addPad(step.profile2.xmax - 102.5, step.sr2.ymax + 2, 's6000', 'negative')
        step.unaffectAll()
        step.VON()
    ...
    def do_au_text(self):
        for signal in self.signalLays:
            ...
            rectx = 9 if board.signal_dict.get(signal) == 't' else -9
            y = step.sr2.ymin - 2
            step.affect(signal)
            dk = 'dkt' if signal == 'gtl' else 'dkb'
            if step.isLayer(dk):
                step.affect(dk)
            text = 'AU:SQ/MM(%)'
            step.addPad(x + rectx, y + 0.55, 'rect20000x1800')
    ...
    def do_cov(self):
        ...
        for cov in self.covs:
            ...
            for n, ty in enumerate(repeat_ty):
                if n % 2:
                    step.addPad(x_min - 1.5, ty - 10, 'r1000')
                    step.addPad(x_max + 1.5, ty - 16, 'r1000')
                else:
                    step.addPad(x_min - 1.5, ty + 13, 'r1000')
                    step.addPad(x_max + 1.5, ty + 13, 'r1000')
            step.unaffectAll()
