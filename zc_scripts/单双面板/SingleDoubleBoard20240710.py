...
class Panel():
    ...
    def make_map_layer(self):
        ...
        x2, y2 = 3.5, step.sr2.ymin + 8.8
        x3, y3 = step.profile2.xmax - 3.5, step.profile2.ymax - 24
        x4, y4 = step.profile2.xmax - 3.5, step.sr2.ymin + 8.8
        ...
        step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 12, 'sy-mark', 'positive', 270)
        # 中间
    ...
    def do_surface(self):
        ...
        if self.dks:
            for n, dk in enumerate(self.dks):
                ...
                step.affect(dk)
                step.srFill_2(sr_margin_x=0.8, sr_margin_y=0.8, stop_at_steps='pcs')
                step.unaffectAll()
                step.affect(dk_tmp)
                ...
                step.COM(f'fill_params,type=standard,origin_type=datum,solid_type=surface,std_type=cross,min_brush=25.4,use_arcs=yes,symbol=,dx=2.54,dy=2.54,x_off=0,y_off=0,std_angle=45,std_line_width={line_width},std_step_dist={side_spacing},std_indent={direction},break_partial=yes,cut_prims=no,outline_draw=yes,outline_width={outline_width},outline_invert=no')
                step.srFill_2(sr_margin_x=0.8, sr_margin_y=0.8, stop_at_steps='pcs', consider_feat='yes')
                step.setAttrFilter('.pattern_fill')
                step.selectAll()
                step.resetFilter()
                if step.Selected_count():
    ...
    def do_sy(self):
        if board.map_flag:
            ...
            for signal in self.signalLays:
                ...
                step.addPad(3.5, step.sr2.ymin + 8.8, sym, 'negative', 270)
                step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 24, sym, 'negative', 90)
                step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 8.8, sym, 'negative', 90)
                step.unaffectAll()
            step.affect('map')
            step.addPad(3.5, step.profile2.ymax - 21, sym, 'negative', 270)
            step.addPad(3.5, step.sr2.ymin + 8.8, sym, 'negative', 270)
            ...
            step.addPad(3.5, step.sr2.ymin + 8.8, 'r2500')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 24, 'r2500')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 8.8, 'r2500')
            step.unaffectAll()
            for drill in self.drills:
                step.affect(drill)
            step.addPad(3.5, step.profile2.ymax - 21, 'r2000')
            step.addPad(3.5, step.sr2.ymin + 8.8, 'r2000')
            step.addPad(step.profile2.xmax - 3.5, step.profile2.ymax - 24, 'r2000')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 8.8, 'r2000')
            step.unaffectAll()
            step.VON()
    ...
    def do_component(self):
        if board.map_flag:
            ...
            for signal in self.signalLays + ['map']:
                ...
                step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 12, 'sy-mark', 'negative', 270)
                # 中间
            ...
            for dk in self.dks:
                step.affect(dk)
            step.addPad(3.5, step.sr2.ymax - 35, 'r2501', 'negative')
            step.addPad(3.5, step.sr2.ymin + 35, 'r2501', 'negative')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymax - 30, 'r2501', 'negative')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 35, 'r2501', 'negative')
            # s1500
            step.addPad(3.5, step.sr2.ymax - 32.5, 'r2501', 'negative')
            step.addPad(3.5, step.sr2.ymin + 32.5, 'r2501', 'negative')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymax - 27.5, 'r2501', 'negative')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 32.5, 'r2501', 'negative')
            # wzdw
            step.addPad(3.5, step.sr2.ymax - 29.5, 'r2501', 'negative')
            step.addPad(3.5, step.sr2.ymin + 29, 'r2501', 'negative')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymax - 24, 'r2501', 'negative')
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 29, 'r2501', 'negative')
            sym = 'r1950'
            step.addPad(3.5, step.sr2.ymax - 23, sym, 'negative', 270)
            step.addPad(3.5, step.sr2.ymin + 25, sym, 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymax - 20, sym, 'negative', 90)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 22, sym, 'negative', 90)
            # c-mark-t
            step.addPad(3.5, step.sr2.ymax - 46, 'r2501', 'negative', 270)
            step.addPad(3.5, step.sr2.ymin + 38, 'r2501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymax - 33, 'r2501', 'negative', 90)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 17, 'r2501', 'negative', 90)
            # wf-mark-t
            step.addPad(3.5, step.sr2.ymax - 40, 'r2501', 'negative', 270)
            step.addPad(3.5, step.sr2.ymin + 17.5, 'r2501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymax - 40, 'r2501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 39, 'r2501', 'negative', 270)
            # sy-mark
            step.addPad(3.5, step.sr2.ymax - 19, 'r3501', 'negative', 270)
            step.addPad(3.5, step.sr2.ymin + 13, 'r3501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymax - 14, 'r3501', 'negative', 270)
            step.addPad(step.profile2.xmax - 3.5, step.sr2.ymin + 12, 'r3501', 'negative', 270)
            step.unaffectAll()
            for yy in self.yys:
                step.affect(yy)
            # sym = 'r1860'
    ...
    def do_donut(self):
        ...
        # 下上
        step.addPad(xb1 - 7.8, step.sr2.ymin - 3.5, '1-ws', angle=270)  # 线宽线距symbol
        ...
        step.addPad(xb3 - 7.8, step.sr2.ymin - 3.5, '1-ws', angle=270)  # 线宽线距symbol
        ...
        step.addPad(xt1 - 7.8, step.sr2.ymax + 3.5, '1-ws', angle=270)  # 线宽线距symbol
        ...
        step.addPad(xt3 + 13.8, step.sr2.ymax + 3.5, '1-ws', angle=270)  # 线宽线距symbol
        # 左右
        step.unaffectAll()
        for zh in self.zhs:
            step.affect(zh)
        ...
        step.addPad(xb1 - 10.5, step.sr2.ymin - 3.5, 'r3500', 'negative')  # 线宽线距symbol
        step.addPad(xb1 - 6.4, step.sr2.ymin - 3.5, 'r3500', 'negative')  # 线宽线距symbol
        step.addPad(xb3 - 10.5, step.sr2.ymin - 3.5, 'r3500', 'negative')  # 线宽线距symbol
        step.addPad(xb3 - 6.4, step.sr2.ymin - 3.5, 'r3500', 'negative')  # 线宽线距symbol
