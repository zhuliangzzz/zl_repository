...
class Text(Feature):
    ...
    def parse(self):
        ...
        self.font     = ss[3]
        self.polarity = self.lookups['polarity'][ss[4]]
        self.rotation = float(ss[5])
        self.mirror   = self.lookups['Y/N'][ss[6]]
        self.xsize    = float(ss[7])
        self.ysize    = float(ss[8])
        self.wfactor  = float(ss[9])
        self.text     = ss[10]
        self.version  = int(ss[11])
...
class Barcode(Feature):
    ...
    def parse(self):
        ...
        self.rotation = float(ss[6])
        self.constant = ss[7]
        self.width    = float(ss[8])
        self.height   = float(ss[9])
