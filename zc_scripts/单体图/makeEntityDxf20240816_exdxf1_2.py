...
class MakeEntityDxf(QWidget, ui.Ui_Form):
    ...
    def generateDxf(self):
        ...
        block1.add_text('1', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((186.4850, -26.8202),align=TextEntityAlignment.MIDDLE)
        block1.add_text('2', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((197.4766, -26.8202),align=TextEntityAlignment.MIDDLE)
        block1.add_text('3', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((208.4681, -26.8202),align=TextEntityAlignment.MIDDLE)
        block1.add_text('4', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((222.2318, -26.8202),align=TextEntityAlignment.MIDDLE)
        block1.add_text('5', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((234.7136, -26.8202),align=TextEntityAlignment.MIDDLE)
        block1.add_text('6', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((245.7052, -26.8202),align=TextEntityAlignment.MIDDLE)
        block1.add_text('7', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((256.6967, -26.8202),align=TextEntityAlignment.MIDDLE)
        block1.add_text('8', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((267.6883, -26.8202),align=TextEntityAlignment.MIDDLE)
        # 上
        ...
        block1.add_text('1', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((186.4850, 38.5043), align=TextEntityAlignment.MIDDLE)
        block1.add_text('2', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((197.4766, 38.5043), align=TextEntityAlignment.MIDDLE)
        block1.add_text('3', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((208.4681, 38.5043), align=TextEntityAlignment.MIDDLE)
        block1.add_text('4', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((222.2318, 38.5043), align=TextEntityAlignment.MIDDLE)
        block1.add_text('5', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((234.7136, 38.5043), align=TextEntityAlignment.MIDDLE)
        block1.add_text('6', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((245.7052, 38.5043), align=TextEntityAlignment.MIDDLE)
        block1.add_text('7', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((256.6967, 38.5043), align=TextEntityAlignment.MIDDLE)
        block1.add_text('8', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((267.6883, 38.5043), align=TextEntityAlignment.MIDDLE)
        # 左
        ...
        block1.add_text('A', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((180.9135, 34.1678), align=TextEntityAlignment.MIDDLE)
        block1.add_text('B', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((180.9135, 28.3864), align=TextEntityAlignment.MIDDLE)
        block1.add_text('C', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((180.9135, 20.2578), align=TextEntityAlignment.MIDDLE)
        block1.add_text('D', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((180.9135, 10.8593), align=TextEntityAlignment.MIDDLE)
        block1.add_text('E', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((180.9135, 0.2478), align=TextEntityAlignment.MIDDLE)
        block1.add_text('F', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((180.9135, -10.3672),align=TextEntityAlignment.MIDDLE)
        block1.add_text('G', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((180.9135, -20.3168),align=TextEntityAlignment.MIDDLE)
        # 右
        ...
        block1.add_text('A', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((274.0387, 34.1678), align=TextEntityAlignment.MIDDLE)
        block1.add_text('B', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((274.0387, 28.3864), align=TextEntityAlignment.MIDDLE)
        block1.add_text('C', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((274.0387, 20.2578), align=TextEntityAlignment.MIDDLE)
        block1.add_text('D', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((274.0387, 10.8593), align=TextEntityAlignment.MIDDLE)
        block1.add_text('E', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((274.0387, 0.2478), align=TextEntityAlignment.MIDDLE)
        block1.add_text('F', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((274.0387, -10.3672), align=TextEntityAlignment.MIDDLE)
        block1.add_text('G', dxfattribs={'style': '宋体', 'height': 0.8793, 'color': 4}).set_placement((274.0387, -20.3168), align=TextEntityAlignment.MIDDLE)
        # 多行文字
        ...
        if len(self.username) > 2:
            posx = 231.7365
        block1.add_text(self.username, dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((posx, -21.4772), align=TextEntityAlignment.TOP_LEFT)
        # ##  填充
        block1.add_text('制表', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((232.1666, -18.6371), align=TextEntityAlignment.TOP_LEFT)
        # 审核
        block1.add_line((242.4088, -22.8616), (242.4088, -17.2702), {'color': 4})
        block1.add_text('审核', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((238.5348, -18.6371), align=TextEntityAlignment.TOP_LEFT)
        block1.add_text('刘晖', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((238.4096, -21.4772), align=TextEntityAlignment.TOP_LEFT)
        # 批准
        block1.add_line((248.3822, -22.8616), (248.3822, -17.2702), {'color': 4})
        block1.add_text('批准', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((244.3122, -18.6371), align=TextEntityAlignment.TOP_LEFT)
        block1.add_text('陈盛新', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((243.7593, -21.4772),align=TextEntityAlignment.TOP_LEFT)
        # FileName
        block1.add_line((260.8797, -22.8616), (260.8797, -17.2702), {'color': 4})
        block1.add_text('File name', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((252.6638, -18.6371),align=TextEntityAlignment.TOP_LEFT)
        block1.add_text(jobname, dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((249.8348, -21.4772), align=TextEntityAlignment.TOP_LEFT)
        # date
        block1.add_line((266.8273, -22.8616), (266.8273, -17.2702), {'color': 4})
        block1.add_text('Date', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((263.0242, -18.6371),align=TextEntityAlignment.TOP_LEFT)
        # Scale
        block1.add_text('Scale', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((269.2613, -18.6371),align=TextEntityAlignment.TOP_LEFT)
        ...
        #
        # 客户编号
        block1.add_text('客户编号：', dxfattribs={'style': '宋体', 'height': 0.8706, 'color': 4}).set_placement((230.8343, -24.3404), align=TextEntityAlignment.TOP_LEFT)
        if cus_number:
            block1.add_text(cus_number, dxfattribs={'style': '宋体', 'height': 0.8706, 'color': 4}).set_placement((237, -24.3404), align=TextEntityAlignment.TOP_LEFT)
        # 图纸名称
        block1.add_text('图纸名称：', dxfattribs={'style': '宋体', 'height': 0.6785, 'color': 4}).set_placement((259.167, -24.3404), align=TextEntityAlignment.TOP_LEFT)

        block1.add_text('单件图', dxfattribs={'style': '宋体', 'height': 1.2724, 'color': 4}).set_placement((265.2669, -24.1882),align=TextEntityAlignment.TOP_LEFT)
        ...
        msp.add_text('江西红板科技股份有限公司', dxfattribs={'style': '宋体', 'height': 1}).set_placement((245.2536, -15.1102), align=TextEntityAlignment.TOP_LEFT)

        msp.add_text('Jiangxi Redboard Technology Co., Ltd.', dxfattribs={'style': '宋体', 'height': 1}).set_placement((245.1233, -16.7272), align=TextEntityAlignment.TOP_LEFT)
        ...
        for n in range(self.tableWidget.rowCount()):
            ...
            msp.add_text(self.tableWidget.cellWidget(n, 1).text(),
                         dxfattribs={'style': '宋体', 'height': 1, 'color': 3}).set_placement((posx + 2, posy - 1.8), align=TextEntityAlignment.LEFT)
