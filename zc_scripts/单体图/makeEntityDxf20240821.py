...
class MakeEntityDxf(QWidget, ui.Ui_Form):
    ...
    def generateDxf(self):
        ...
        block1.add_text('导出资料', dxfattribs={'style': '宋体', 'height': 0.8, 'color': 0}).set_placement((244, -43.5), align=TextEntityAlignment.MIDDLE)
        ...
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 1}).set_location((126.4, -133))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        text = '''正反面白色字符'''
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 0}).set_location((126.4, -136))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        text = '''/'''
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 0}).set_location((126.4, -139))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        ...
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 0}).set_location((126.4, -145))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        text = '''RoHS 2.0 REACH'''
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 3}).set_location((126.4, -148))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        text = '''丝印、补强对位公差:±0.30'''
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 0}).set_location((171, -127))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        text = '''孔径公差:士0.075'''
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 0}).set_location((171, -129.25))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        text = '''蚀刻公差:士20%'''
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 0}).set_location((171, -131.5))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
        text = '''未标注公差:士0.1'''
        mtext = block1.add_mtext(text, dxfattribs={'style': '宋体', 'color': 0}).set_location((171, -133.75))
        mtext.dxf.char_height = 0.7
        mtext.dxf.attachment_point = MTEXT_TOP_LEFT
