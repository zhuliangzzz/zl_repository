...
class Panel():
    ...
    def do_cov(self):
        ...
        for name, xmin, xmax, ymin, ymax in zip(step.info2.get('gREPEATstep'),
                ...
                if xmin == set_x_min:
                    actual_ty.append(ymin)
                    actual_ty.append(ymax)
