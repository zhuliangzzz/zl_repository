...
# Form implementation generated from reading ui file 'MultiLayerBoardUI.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayout_11.addWidget(self.lineEdit_margin_x)
        ...
        self.horizontalLayout_11.addWidget(self.lineEdit_margin_y)
        ...
        self.comboBox_structure = QtWidgets.QComboBox(Form)
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(9)
        font.setBold(False)
        font.setWeight(50)
        self.comboBox_structure.setFont(font)
        self.comboBox_structure.setEditable(True)
        self.comboBox_structure.setObjectName("comboBox_structure")
        self.horizontalLayout_10.addWidget(self.comboBox_structure)
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "多层板板边脚本"))
        ...
        self.label_10.setText(_translate("Form", "pnl铜皮边距："))
        ...
        self.label_9.setText(_translate("Form", "叠构："))
