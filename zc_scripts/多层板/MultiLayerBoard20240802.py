...
class Panel():
    ...
    def make_map_layer(self):
        ...
        #
        sym = 'ldi-mark-t'
        step.addPad(28, step.sr2.ymin - 2, sym)
        step.addPad(28, step.sr2.ymax + 2, sym)
        step.addPad(step.profile2.xmax - 31, step.sr2.ymax + 2, sym)
        step.addPad(step.profile2.xmax - 29, step.sr2.ymin - 2, sym)
        # lpi
    ...
    def do_ldi(self):
        if board.map_flag:
            ...
            for signal in self.signalLays:
                ...
                if step.isLayer(dk):
                    step.affect(dk)
                step.addPad(28, step.sr2.ymin - 2, sym, 'negative')
                step.addPad(28, step.sr2.ymax + 2, sym, 'negative')
                step.addPad(step.profile2.xmax - 31, step.sr2.ymax + 2, sym, 'negative')
                step.addPad(step.profile2.xmax - 29, step.sr2.ymin - 2, sym, 'negative')
                step.unaffectAll()

            step.affect('map')
            step.addPad(28, step.sr2.ymin - 2, 'ldi-mark-t')
            step.addPad(28, step.sr2.ymax + 2, 'ldi-mark-t')
            step.addPad(step.profile2.xmax - 31, step.sr2.ymax + 2, 'ldi-mark-t')
            step.addPad(step.profile2.xmax - 29, step.sr2.ymin - 2, 'ldi-mark-t')
            step.unaffectAll()
            step.VOF()
            for drill in self.drills:
                step.affect(drill)
            step.addPad(28, step.sr2.ymin - 2, 'r1000')
            step.addPad(28, step.sr2.ymax + 2, 'r1000')
            step.addPad(step.profile2.xmax - 31, step.sr2.ymax + 2, 'r1000')
            step.addPad(step.profile2.xmax - 29, step.sr2.ymin - 2, 'r1000')
            step.unaffectAll()
            step.VON()
